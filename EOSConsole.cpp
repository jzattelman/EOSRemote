...
QState EOSConsole::Initial(EOSConsole *me, QEvt const *e) 
{
    return Q_TRAN(&EOSConsole::Inactive);
}

QState EOSConsole::Inactive(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case TICK_SIG: 
...
QState EOSConsole::Active(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case Q_INIT_SIG: 
...
QState EOSConsole::ChangeApertureMenu(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case Q_ENTRY_SIG:
...
QState EOSConsole::ChangeShutterSpeedMenu(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case Q_ENTRY_SIG:
...
QState EOSConsole::ChangeWBMenu(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case Q_ENTRY_SIG:
...
QState EOSConsole::ChangeIsoMenu(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case Q_ENTRY_SIG:
...
QState EOSConsole::ChangePStyleMenu(EOSConsole *me, QEvt const *e) 
{
    switch (e->sig) 
    {
        case Q_ENTRY_SIG:
